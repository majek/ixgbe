 ...
 **/
s32 ixgbe_get_link_settings_82598(struct ixgbe_hw *hw, u32 *speed,
				  bool *autoneg)
{
 ...
 **/
s32 ixgbe_check_mac_link_82598(struct ixgbe_hw *hw, u32 *speed,
			       bool *link_up)
{
	u32 links_reg;
 ...
 **/
s32 ixgbe_check_copper_link_82598(struct ixgbe_hw *hw, u32 *speed,
				  bool *link_up)
{
	s32 status;
	u32 phy_speed = 0;
